...
import type { XhtDictRadioEmits, XhtDictRadioProps } from '@/components/dict/xht-dict-radio/types'
...
const props = withDefaults(defineProps<XhtDictRadioProps>(), {
  border: false,
})

const emits = defineEmits<XhtDictRadioEmits>()
