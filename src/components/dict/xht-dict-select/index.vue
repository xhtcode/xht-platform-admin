...
import type { XhtDictSelectEmits, XhtDictSelectProps } from '@/components/dict/xht-dict-select/types'
...
const props = withDefaults(defineProps<XhtDictSelectProps>(), {
...
const emits = defineEmits<XhtDictSelectEmits>()
