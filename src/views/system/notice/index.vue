...
import type { SysNoticeQueryRequest, SysNoticeResponse } from '@/service/model/system/notice.model'
import {
  querySysNoticePage,
  removeSysNoticeById,
...
} from '@/service/api/system/notice.api'
...
const noticeBaseFrom = defineAsyncComponent(() => import('@/views/system/notice/components/base-from.vue'))
