...
export const SysMenuColumnOption: ColumnConfig<SysMenuResponse> = {
  ...
  menuCache: { desc: '缓存状态', visible: false, disabled: false },
  ...
  viewPath: { desc: '组件视图', visible: false, disabled: false },
  frameFlag: { desc: '外链', visible: false, disabled: false },
  menuPath: { desc: '路由地址', visible: false, disabled: false },
