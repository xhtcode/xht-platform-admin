...
import type { SysMessageQueryRequest, SysMessageResponse } from '@/service/model/notice/message.model'
import { queryAdminPage, updateCancelAll } from '@/service/api/notice/message.api'
import { useMessage, useMessageBox } from '@/hooks/use-message'
import type { ColumnConfig } from '@/components/table-tool-bar/types'
import { sysMessageColumnOption } from '@/views/notice/message/message.data'
import { RefreshLeft, Refresh, Search, View } from '@element-plus/icons-vue'

defineOptions({ name: 'SysMessageView' })

const messageView = defineAsyncComponent(() => import('@/views/notice/message/components/message-view.vue'))
