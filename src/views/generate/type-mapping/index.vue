  ...
  <div class="main-container-none">
    <div class="main-container-auto main-container-view">
      ...
      >
        ...
        <el-table-column label="数据库类型" prop="dbType" align="center" />
        <el-table-column label="数据库数据类型" prop="dbDataType" align="center" />
        <el-table-column label="目标编程语言" prop="targetLanguage" align="center" />
        <el-table-column label="目标语言数据类型" prop="targetDataType" align="center" />
        <el-table-column label="导入包路径" prop="importPackage" align="center" />
