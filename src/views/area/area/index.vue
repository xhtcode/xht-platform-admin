...
import {
  ...
  saveSysArea,
  updateSysArea,
} from '@/service/api/area/area.api'
import { useMessage, useMessageBox } from '@/hooks/use-message'
import type { ColumnConfig } from '@/components/table-tool-bar/types'
import { sysAreaColumnOption, sysAreaOperationForm, sysAreaOperationRules } from '@/views/area/area/area.data'
...
defineOptions({ name: 'SysAreaView' })
