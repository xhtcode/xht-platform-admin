  ...
  <div class="xht-view-container user-select-none">
    <el-splitter>
      <el-splitter-panel :resizable="false">
        ...
        <!-- 成功提示 -->
        <el-form ref="formRef" :model="form" :rules="rules" label-width="120px" class="p-6">
          <!-- 旧密码 -->
          ...
          <el-form-item label="手机号" prop="phone">
            <el-input v-model="form.phone" placeholder="请输入手机号" :minlength="11" :maxlength="11" show-word-limit />
          </el-form-item>

          <!-- 验证码 -->
          <el-form-item label="验证码" prop="verifyCode">
            <el-input v-model="form.verifyCode" placeholder="请输入验证码" :maxlength="6" show-word-limit class="flex-1" />
            <el-button type="primary" plain :disabled="!canSendCode" @click="sendVerifyCode" class="ml-3">
