...
type UserInfoType = 'UserInfo' | 'PassWord' | 'MyMessage' | 'LoginLog'
...
<template>
  <div class="h-full flex gap-2">
    ...
    <div class="xht-view-container-none flex-[4]">
      <div class="user-select-none pb-2 text-center text-18px font-bold">个人信息</div>
      <div class="xht-view-main-padding user-select-none flex-1 overflow-x-hidden overflow-y-auto">
